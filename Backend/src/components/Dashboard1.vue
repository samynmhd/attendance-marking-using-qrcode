...
export default {
  ...
  created() {
    ...
    console.log(token);
    axios.get(`${baseURL}/api/students/subjects/${this.$session.get('id')}/${this.user.semester}`)
      .then(response => {
    ...
    axios.get(`${baseURL}/api/students/attendance/${this.$session.get('id')}/${this.user.semester}`)
      .then(response => {
        console.log(response);
        this.bool = false;
  ...
  methods: {
    getAttendance() {
      ...
      async function getData() {
        try {
          const response = await axios.get(`${baseURL}/api/students/attendance/${id}`);
          console.log(response);
