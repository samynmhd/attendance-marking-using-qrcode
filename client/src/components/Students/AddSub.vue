...
<div class="container" id="body">
  ...
  <div v-if="checkbox && checkbox.length" class="jumbotron">
    <div v-for="data in checkbox" class="container form-group">
...
export default {
  ...
  created() {
    ...
    axios.get(`${this.baseURL}/api/students/stdaddsub/${uid}/${sem}/${course}`)
      .then(response => {
  ...
  methods: {
    ...
    select(evt) {
      ...
      axios.post(`${this.baseURL}/api/students/selectsubs/${uid}/${sem}`, this.checkbox)
        .then(response => {
          console.log(response);
